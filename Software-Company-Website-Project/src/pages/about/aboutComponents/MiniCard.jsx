...
const MiniCard = ({head, no, para}) => {
  return (
    <div className='bg-[#238636]/20 border border-[#238636]/30 flex flex-col justify-center items-center text-center py-6 pb-8 px-4 sm:pt-0 lg:text-start lg:px-6 lg:items-start'>
