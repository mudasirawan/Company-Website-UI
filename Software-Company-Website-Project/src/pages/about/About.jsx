...
import hrl from "../../assets/hrl.png";
  ...
  return (
    <div className="mx-auto translate-x-[-50%] absolute left-[50%] w-screen  max-w-[1600px] ">
      ...
      <div className=" w-full ">
        ...
        <div className=" bg-[#58a6ff]/10 w-full flex px-8 lg:px-20  mt-11 lg:mt-17 flex-col justify-center py-12 items-center lg:py-25">
          <h1 className="text-[1.8rem] leading-none font-semibold text-center">What you can expect from our team</h1>
        ...
        <div className="flex flex-col px-8 gap-6 mt-10 py-8  lg:px-20 lg:flex-row lg:gap-14">
          ...
          <ParaBox head='Our Mission' para='Tech Solutions is a leading web design and mobile app development firm that works with clients ranging from small businesses to major corporations to create online and mobile-enabled apps. We are known for utilising the strength of our knowledge and talents to create profitable, flourishing, engaging, and simple-to-use applications. We exclusively work with the best iOS, Android, and web app developers, so you can outsource your project and obtain a high-quality result.'/>
        </div>
        {/* Capital Smart City Project Section */}
        <div className="px-8 lg:px-20 mt-10 py-8 bg-[#58a6ff]/10 rounded-lg">
          <h1 className="text-[1.8rem] font-semibold text-center">Our Projects</h1>
          <div className="flex flex-col items-center gap-6 mt-6 lg:flex-row lg:justify-center">
            <img src={logo1} alt="Capital Smart City" className="w-64 h-auto" />
            <div className="text-center lg:text-left">
              <h2 className="text-xl font-semibold">Capital Smart City</h2>
              <p className="text-gray-700">Capital Smart City represents a groundbreaking initiative by HRL, offering an ultra-modern residential experience in Islamabad. As Pakistan's first fully integrated smart housing society, it combines cutting-edge technology with sustainable living solutions, providing residents with advanced security systems, eco-friendly amenities, and state-of-the-art infrastructure that sets new standards for urban development.</p>
              <p className="text-gray-700 mt-4">Since 1962, Habib Rafiq (Pvt.) Limited has come a long way to symbolize commitment, distinction and professional Excellence by meeting the stringent, demanding and extra ordinary work requirements of the client.</p>
            </div>
        ...
        {/* Cards Section */}
        <div className="bg-[#238636]/10 mt-10 py-10 px-8 lg:px-20 flex flex-col gap-8 lg:flex-row lg:items-center ">
          <div className="flex flex-col text-center items-center gap-5 lg:w-[50%] lg:text-start lg:items-start">
            ...
            <p className="text-[0.95rem]">Working with Tech Solutions has had a long-term positive influence on our capacity to innovate and execute quickly. There is a great focus on not simply doing what you ask for by the personnel there.</p>
