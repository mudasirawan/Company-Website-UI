...
const FormPage = () => {
  const [state, handleSubmit] = useForm("mgvrqrgw");
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          ...
          <div className="flex flex-col gap-6 flex-1">
            ...
            <input
              ...
              placeholder="Skype"
            />
            <ValidationError prefix="Skype" field="skype" errors={state.errors} />
          </div>
        </div>
        <textarea
          id="message"
