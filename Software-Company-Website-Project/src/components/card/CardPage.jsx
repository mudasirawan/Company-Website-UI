...
const CardPage = () => {
  return (
    <div className='mt-16 sm:mt-20 md:mt-24 lg:mt-30 max-w-[1600px] mx-auto px-2 sm:px-4'>
      <div className='text-center flex flex-col items-center gap-2 sm:gap-3'>
        <h3 className='uppercase text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl font-semibold'>Industries we Serve</h3>
        <p className='uppercase text-xs sm:text-sm md:text-base lg:text-lg w-[90%] sm:w-[80%] md:w-[60%] lg:w-[40rem] px-2'>We've had the pleasure of working with a variety of sectors, addressing key challenges and delighting end customers with our engaging mobile apps.</p>
      </div>
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 xl:gap-10 justify-items-center px-2 sm:px-4 lg:px-8 xl:px-10 mt-8 sm:mt-10 md:mt-12'>
